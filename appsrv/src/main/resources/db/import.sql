...
insert into db.APILink(apiLinkId, url, description, user, password, shopId) values (1, 'https://www.faie.at/backend/export/index/agraraktionen.csv?feedID=68&hash=1bfdc5718d84ebfd191e9ee6617a7764', 'Faie', '', '', 1);
insert into db.APILink(apiLinkId, url, description, user, password, shopId) values (2, '', '', 'wdawd', 'awd', 2);
insert into db.APILink(apiLinkId, url, description, user, password, shopId) values (3, '', '', 'awd', 'awd', 2);
